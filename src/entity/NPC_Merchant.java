...
//        speed = 2;
    ...
    public void setDialogue(){
        ...
        // DIALOGUE SET 1
        dialogues[0][0] = "Hello stranger.." +
                "/nWhat is it that you want?" +
                "/nTRade? or Sell?";
        dialogues[1][0] = "Come back soon...";
        dialogues[2][0] = "Not enough coins my friend..";
        dialogues[3][0] = "You can't carry anymore!";
        dialogues[4][0] =  "You cannot sell" +
                "/nAn equipped item...";
