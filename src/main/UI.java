        ...
        for (int i = 0; i < gp.monster[1].length; i++) {
            ...
            if (monster != null && monster.isOnScreen()) {
                ...
                if (monster.hpBarOn && !monster.boss) {
                    ...
                    g2.fillRect(monster.getScreenX() - 3, monster.getScreenY() - 6, gp.tileSize + 5, 15);
                    // fill
                    g2.setColor(new Color(255, 0, 90));
                    g2.fillRect(monster.getScreenX(), monster.getScreenY() - 4, (int) hpBarValue, 10);
